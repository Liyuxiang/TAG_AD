...
#define RF_CONF_TXPOW_MASK		0x001F0000UL   /* turn on power to analog blocks */
...
#define TC_SARL_SAR_LTEMP_OFFSET	(3)			/* Latest SAR reading for Temperature level */
#define TC_SARL_SAR_LVBAT_OFFSET	(4)			/* Latest SAR reading for Voltage level */
/* offset from TX_CAL_ID in bytes */
