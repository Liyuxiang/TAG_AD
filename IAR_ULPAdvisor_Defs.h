...
#define __FLOAT_ALIGN__ 2
#define __DOUBLE_SIZE__ 4
#define __DOUBLE_ALIGN__ 2
#define __LONG_DOUBLE_SIZE__ 4
#define __LONG_DOUBLE_ALIGN__ 2
#define __NAN_HAS_HIGH_MANTISSA_BIT_SET__ 1
#define __SUBNORMAL_FLOATING_POINTS__ 0
...
#define __JMP_BUF_ELEMENT_TYPE__ unsigned short int
#define __JMP_BUF_NUM_ELEMENTS__ 10
#define __TID__ 0xab00
#define __VER__ 610
#define __SUBVERSION__ 2
#define __BUILD_NUMBER__ 871
#define __IAR_SYSTEMS_ICC__ 8
#define __VA_STACK_DECREASING__ 1
#define __VA_STACK_ALIGN__ 2
#define __VA_STACK_ALIGN_EXTRA_BEFORE__ 0
#define __LITTLE_ENDIAN__ 1
#define __BOOL_TYPE__ unsigned char
#define __WCHAR_T_TYPE__ unsigned short int
#define __WCHAR_T_SIZE__ 2
#define __WCHAR_T_MAX__ 0xffff
#define __DEF_PTR_MEM__ __data16
...
#define __DATA_MEMORY_LIST1__() __DATA_MEM_HELPER1__(__data16, 0 )  __DATA_MEM_HELPER1__(__regvar, 1 )
#define __DATA_MEMORY_LIST2__(_P1) __DATA_MEM_HELPER2__(__data16, 0 ,  _P1 )  __DATA_MEM_HELPER2__(__regvar, 1 ,  _P1 )
#define __DATA_MEMORY_LIST3__(_P1, _P2) __DATA_MEM_HELPER3__(__data16, 0 ,  _P1 ,  _P2 )  __DATA_MEM_HELPER3__(__regvar, 1 ,  _P1 ,  _P2 )
#define __DATA_MEM0__ __data16
...
#define __DATA_MEM0_MAX_SIZE__ 0xffff
#define __DATA_MEM0_HEAP_SEGMENT__ "DATA16_HEAP"
#define __DATA_MEM0_PAGE_SIZE__ 0
#define __DATA_MEM0_HEAP__ 0
#define __DATA_MEM1__ __regvar
#define __DATA_MEM1_POINTER_OK__ 0
#define __DATA_MEM1_UNIQUE_POINTER__ 0
...
#define __DATA_PTR_MEMORY_LIST1__() __DATA_PTR_MEM_HELPER1__(__data16, 0 )
#define __DATA_PTR_MEMORY_LIST2__(_P1) __DATA_PTR_MEM_HELPER2__(__data16, 0 ,  _P1 )
#define __DATA_PTR_MEMORY_LIST3__(_P1, _P2) __DATA_PTR_MEM_HELPER3__(__data16, 0 ,  _P1 ,  _P2 )
#define __VAR_MEMORY_LIST1__() __VAR_MEM_HELPER1__(__data16, 0 )
#define __VAR_MEMORY_LIST2__(_P1) __VAR_MEM_HELPER2__(__data16, 0 ,  _P1 )
#define __VAR_MEMORY_LIST3__(_P1, _P2) __VAR_MEM_HELPER3__(__data16, 0 ,  _P1 ,  _P2 )
#define __VARD_MEMORY_LIST1__() __VARD_MEM_HELPER1__(__data16, 0, _ )
#define __HEAP_MEM0__ 0
#define __HEAP_MEMORY_LIST1__() __HEAP_MEM_HELPER1__(__data16, 0 )
#define __HEAP_MEMORY_LIST2__(_P1) __HEAP_MEM_HELPER2__(__data16, 0 ,  _P1 )
#define __HEAP_MEMORY_LIST3__(_P1, _P2) __HEAP_MEM_HELPER3__(__data16, 0 ,  _P1 ,  _P2 )
#define __HVAR_MEMORY_LIST1__() __HVAR_MEM_HELPER1__(__data16, 0 )
#define __HEAPD_MEMORY_LIST1__() __HEAPD_MEM_HELPER1__(__data16, 0, _ )
#define __HEAPU_MEMORY_LIST1__() __HEAPU_MEM_HELPER1__(__data16, 0 )
#define __MULTIPLE_HEAPS__ 1
#define __TOPM_DATA_MEMORY_LIST1__()
#define __TOPM_DATA_MEMORY_LIST2__(_P1)
#define __TOPM_DATA_MEMORY_LIST3__(_P1, _P2)
#define __TOPP_DATA_MEMORY_LIST1__() __TOPP_DATA_MEM_HELPER1__(__data16, 0 )
#define __TOPP_DATA_MEMORY_LIST2__(_P1) __TOPP_DATA_MEM_HELPER2__(__data16, 0 ,  _P1 )
#define __TOPP_DATA_MEMORY_LIST3__(_P1, _P2) __TOPP_DATA_MEM_HELPER3__(__data16, 0 ,  _P1 ,  _P2 )
#define __DEF_HEAP_MEM__ __data16
#define __PRAGMA_PACK_ON__ 1
#define __MULTIPLE_INHERITANCE__ 1
#define _CLIB_FP_INF_NAN 1
#define _DLIB_SMALL_TARGET 1
#define __430X__ 1
#define __430__ 0
#define __CODE_MODEL_LARGE__ 1
#define __CODE_MODEL_SMALL__ 0
#define __CODE_MODEL__ __CODE_MODEL_SMALL__
#define __CORE__ __430__
#define __DATA_MODEL_LARGE__ 2
#define __DATA_MODEL_MEDIUM__ 1
#define __DATA_MODEL_SMALL__ 0
#define __DATA_MODEL__ __DATA_MODEL_SMALL__
#define __IAR_SYSTEMS_ICC __IAR_SYSTEMS_ICC__
#define __ICC430__ 1
#define __REGISTER_MODEL_REG16__ 0
#define __REGISTER_MODEL_REG20__ 1
#define __REGISTER_MODEL__ __REGISTER_MODEL_REG16__
#define __PLAIN_INT_BITFIELD_IS_SIGNED__ 1
#define __HAS_LOCATED_DECLARATION__ 1
#define __IAR_COMPILERBASE__ 593670
#define __DATE__ "Oct 15 2015"
#define __TIME__ "09:35:37"
#define __STDC__ 1
#define __STDC_VERSION__ 199901L
#define __STDC_HOSTED__ 1
#define __EDG_TYPE_TRAITS_ENABLED 1
#define __EDG__ 1
#define __EDG_VERSION__ 403
#define __EDG_SIZE_TYPE__ unsigned int
#define __EDG_PTRDIFF_TYPE__ int
#define __EDG_JMP_BUF_ELEMENT_TYPE unsigned short
#define __EDG_JMP_BUF_NUM_ELEMENTS 10
#define __EDG_DELTA_TYPE int
#define __EDG_VIRTUAL_FUNCTION_INDEX_TYPE unsigned short
#define __EDG_VAR_HANDLE_TYPE unsigned short
#define __EDG_REGION_NUMBER_TYPE unsigned short
#define __EDG_NULL_EH_REGION_NUMBER 65535
#define __EDG_LOWER_VARIABLE_LENGTH_ARRAYS 1
#define __EDG_ELEM_COUNT_PARAM_TYPE long
...
#define __EDG_CPP0X_IL_EXTENSIONS_SUPPORTED 1
#define __MSP430G2755__ 1
#define _DLIB_CONFIG_FILE_HEADER_NAME "D:\Program Files\IAR Systems\Embedded Workbench 7.0\430\lib\dlib\dl430fn.h"
#define _DLIB_CONFIG_FILE_STRING "D:\\Program Files\\IAR Systems\\Embedded Workbench 7.0\\430\\lib\\dlib\\dl430fn.h"
#define __VERSION__ "IAR C/C++ Compiler V6.10.2.50871/W32 for MSP430"
